...
Submissions will close late November with the winner announced in March.
...
1. The judging panel will comprise committee members of the newly formed [Statistical Computing and Visualisation Section of the Statistical Society of Australia](https://www.statsoc.org.au/Statistical-Computing-and-Visualisation-Section).
...
<ul class="fa-ul">
  <li><span class="fa-li"><i class="fas fa-file-code"></i></span>[Application form](https://docs.google.com/forms/d/e/1FAIpQLSfBkq7OjYWGEHxtwoTqP_yIMMro0gPokW3k6hp52f2a9NYEmA/viewform?usp=sf_link)</li>
...
```{r date, echo = FALSE}
tribble(~Date, ~What,
        "Tue 20th Sep 2022", "Opening of submissions",
        "<strike>Fri 25th Nov 2022</strike> Fri 16th Dec 2022", "Close of submissions",
        "March meeting", "Announcement of the award winner") %>% 
  knitr::kable()
```
...
The awardee will receive a cash prize of $1,000 and an opportunity to present their work at an event planned in 2023.
